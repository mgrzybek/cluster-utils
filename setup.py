...
setup(
	...
	scripts = [ 'bin/cluster_set_cpuset', 'bin/cluster_get_cpuset_allocation', 'bin/cluster_get_mem_allocation', 'bin/cluster_get_cluster_usage', 'bin/sbd_list', 'bin/sbd_dump', 'sbd_clear_nodes' ],
	install_requires = [''],
